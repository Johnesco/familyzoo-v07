# Family Zoo — v07 — Locked Doors & Keys — Claude Project Memory
...
**Name:** Family Zoo — v07 — Locked Doors & Keys
**Purpose:** Sharpee tutorial step 7 — Locked Doors & Keys.
...
**Repository:** https://github.com/Johnesco/familyzoo-v07
**Live:** https://johnesco.github.io/familyzoo-v07/
...
├── familyzoo-07.js         the built story bundle
...
The steps are **generated**, not hand-edited: each one is `familyzoo.story` sliced to the blocks introduced at or before this step, with per-step room prose so a description never names a thing the step has not created yet. Change the master and the step map, then re-lay the steps — do not hand-edit `familyzoo-v07.story`.
